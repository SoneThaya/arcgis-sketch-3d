...
const Map = () => {
  ...
  useEffect(() => {
    loadModules([
      ...
      "esri/widgets/Expand",
    ]).then(([Map, SceneView, GraphicsLayer, SketchViewModel, Expand]) => {
    ...
    <>
      ...
      <div id="sketchPanel" class="esri-widget">
        ...
        <div id="actionbuttons">
          <button id="cancel" class="esri-button">
            Cancel
          </button>
          <button id="done" class="esri-button">
            Done
          </button>
        </div>
        ...
        <table id="configurationTable">
          <tbody>
            <tr>
              <td>
                <label for="enabledcheckbox" id="enabledcheckboxlabel">
                  <b>
                    Snapping enabled (<div id="snappingctrlkey">CTRL-key</div>)
                  </b>
                </label>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <input type="checkbox" id="selfsnappingcheckbox" />
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <input type="checkbox" id="featuresnappingcheckbox" />
              </td>
            </tr>
          </tbody>
        </table>
